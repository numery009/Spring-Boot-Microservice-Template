...
public class Person {
	...
	public Person() {
		super();
		// Person Auto-generated constructor stub
	}

	public Person(long id, String firstName, String lastName, Date dateOfTask,
			int age, String socialSecurityNumber) {
		super();
		this.id = id;
	...
	public String toString() {
		return "person [id=" + id + ", firstName=" + firstName + ", lastName="
				+ lastName + ", dateOfTask=" + dateOfTask + ", age=" + age
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((dateOfTask == null) ? 0 : dateOfTask.hashCode());
		result = prime * result
